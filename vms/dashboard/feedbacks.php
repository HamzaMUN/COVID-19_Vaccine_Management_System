...
<head>
  ...
  <title>Feedbacks | COVID-19 Vaccine Management System</title>
          ...
          <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                  ...
                  $sql = "SELECT * FROM feedback WHERE is_read = 0 ORDER BY feedback_id ASC";
                  ...
                  <?php
                    ...
                    ?>
                      <tr>
                          ...
                          <td><?php echo $feedback_time; ?></td>
                          <td>
                            <button onclick="window.location.href='mark_feedback.php?id=<?php echo $feedback_id; ?>'">Mark as read</button>
                          </td>
                        </tr>
                    <?php
                    $serial_no += 1;
                  ...
                  {
                    echo "<h2>No Unread Feedbacks</h2>";
                  }
                  mysqli_close($conn);
                  ?>
                </div>
